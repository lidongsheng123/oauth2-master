...
import com.oauth2.security.controller.CustomLoginController;
import com.oauth2.security.exception.ValidateCodeException;
...
public class ImageCodeValidateFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public ImageCodeValidateFilter(SecurityProperties securityProperties, CustomAuthenticationFailureHandler customAuthenticationFailureHandler) {
